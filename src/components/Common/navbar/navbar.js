          ...
          >
            <Container>
              ...
              <Menu.Menu position='right' className='navFont'>
                ...
                {/* <Menu.Item name='Explore Projects' as={Link} to={`/${this.props.cohort}/explore`} active={activeItem === 'explore'} onClick={this.handleItemClick} className='navFont' /> */}
                ...
                {/* <Menu.Item name='Discover Resources' as={Link} to={`/${this.props.cohort}/explore`} active={activeItem === 'explore'} onClick={this.handleItemClick} className='navFont' /> */}
